...
Co-Authored-By: Codex frontier model 4.7 (1M context) <noreply@codex.local>
EOF
)"
```
...
- Modify: `AGENTS.md` (Skills Overview + v3.6.4 Key Additions)
...
```bash
cd ~/Projects/academic-research-skills
git add -A scripts/check_spec_consistency.py academic-pipeline/SKILL.md academic-paper/SKILL.md academic-paper-reviewer/SKILL.md deep-research/SKILL.md AGENTS.md README.md README.zh-TW.md
git status
git commit -m "$(cat <<'EOF'
chore(v3.6.4): version bump sweep 3.6.3 → 3.6.4

check_spec_consistency version pin, all four SKILL.md footers,
AGENTS.md Skills Overview table + new v3.6.4 Key Additions
...
- Version bump sweep 3.6.3 → 3.6.4 across four SKILL.md, AGENTS.md, README, consistency lint.
