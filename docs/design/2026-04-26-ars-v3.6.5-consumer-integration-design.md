...
- **Explicitly untouched:**
  ...
  - All SKILL.md version fields, `MODE_REGISTRY.md`, `AGENTS.md` Skills Overview, `README.md`, `README.zh-TW.md`, `CHANGELOG.md` (PR-B scope).
...
5. `AGENTS.md` Skills Overview table — three skill versions aligned.
